...
distance2peak_all=plot_grid(allPeakplot,score20plot,score50plot,score100plot,score200plot, score500plot)

ggsave("../output/plots/QC_plots/distance2peak_all.png", distance2peak_all, width=8, height=6)
```
...
effectsize$colorsF=ifelse(effectsize$logef >= 1.18, "darkviolet", ifelse(effectsize$logef <= -.61,"deepskyblue3", "black"))
...
legend("bottomleft", legend=c("Top 5%: Total", "Bottom 5%: Nuclear"),
       col=c( "darkviolet","deepskyblue3"), pch=19, cex=0.8)
