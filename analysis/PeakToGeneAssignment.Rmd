...
APAqtl_permuted_transcript_3norm.sh 
The nuclear chrom 3 file did not run. I will try the --normal condition.  
```{bash,eval=F}
#!/bin/bash
...
```{r}
grid.newpage()
qtloverlap_gene=draw.pairwise.venn(area1 = 2272, area2 = 602, cross.area = 398, category = c("Nuclear: QTL genes", "Total: QTL genes"), lty = rep("solid", 2), fill = c("light blue", "pink"), alpha = rep(0.5, 2), cat.pos = c(0, 0), cat.dist = rep(0.025, 2))
