...
```{r}
grid.newpage()
qtloverlap=draw.pairwise.venn(area1 = 2901, area2 = 529, cross.area = 148, category = c("Nuclear: QTLs", "Total: QTLs"), lty = rep("solid", 2), fill = c("light blue", "pink"), alpha = rep(0.5, 2), cat.pos = c(0, 0), cat.dist = rep(0.025, 2))
