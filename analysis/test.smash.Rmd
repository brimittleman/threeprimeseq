...
plot(actb_bppos,actb_test_matrix[1,]+actb_test_matrix[2,],xlab="position",ylab="counts",pch=16,cex=0.5, col=alpha("black",1))

plot(actb_bppos,actb_res$est,type='l',xlab="position",ylab="intensity")
