...
write.table(infile_filt, filename =  opt$output, quote=F, col.names = T, row.names = F, sep="\t")
...
Rscript filter80percA.R $1 /project2/gilad/briana/threeprimeseq/data/nuc6A_filt/filtnucA.${describer}.txt
...
Error in getopt(spec = spec, opt = args) : 
  "/project2/gilad/briana/threeprimeseq/data/nuc_6up/sixupnuc.18486-N_S10_R1_001.bed" is not a valid option, or does not support an argument
